...
function saleCoklat(list, money) {
	...
	// Selection Sort list dari harga yang paling besar ke harga yang paling kecil
	...
	// push nama cokelat dari list ke choco untuk menghitung total cokelat yang dibeli
	for (var i = 0; i < list.length; i++) {
		choco.push([list[i][0], `0`]);
	}

	// Mencari Cokelat yang dapat dibeli saat belanja sampai money tidak mencukupi
	...
	// push choco yang dibeli ke output
